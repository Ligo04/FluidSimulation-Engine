...
class IEffectDisplacementMap: public IEffectTextureNormalMap
{
    public:
        ...
        virtual void SetTessInfo(float maxTessDistance, float minTessDistance, float minTessFactor, float maxTessFactor)
            = 0;
};
...
class BasicEffect: public IEffect, public IEffectTransform, public IEffectTextureDiffuse, public IEffectDisplacementMap
{
    public:
        ...
        // 设置曲面细分信息
        void SetTessInfo(float maxTessDistance,
                         float minTessDistance,
                         float minTessFactor,
                         float maxTessFactor) override;
        ...
        void SetRenderDefault(ID3D11DeviceContext *deviceContext,
                              RenderType           type,
                              RSFillMode           fillMode = RSFillMode::Solid);
        // 带法线贴图的绘制
...
class SSAOEffect: public IEffect, public IEffectTransform, public IEffectTextureDiffuse, public IEffectDisplacementMap
{
    public:
        ...
        // 绘制带位移映射的法向量和深度贴图
        void SetRenderNormalDepthWithDisplacementMap(ID3D11DeviceContext *deviceContext,
                                                     RenderType           type,
                                                     bool                 enableAlphaClip = false);
